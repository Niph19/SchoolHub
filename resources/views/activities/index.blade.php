<!DOCTYPE html>
<html lang="en">
<x-head :title="$title ?? 'SchooHub – Activities'" />

<body>
    @include('components.navbar')
    @yield('content')
    <h1 class="block text-5xl text-center justify-center font-bold text-foreground mt-5 mb-15">Kegiatan Terbaru</h1>
    <section class="text-gray-600 body-font">
        <div class="container px-5 pt-10 pb-5 mx-auto">
            <div class="flex flex-wrap -m-4">
                <div class="grid grid-cols-3 gap-3">
                    @foreach($dataActivitie as $data)
                    <div class="p-4">
